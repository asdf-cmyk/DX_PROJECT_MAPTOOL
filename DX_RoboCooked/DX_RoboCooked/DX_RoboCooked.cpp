...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
  ...
  /* RECT winRect;
   ...
   g_DXRenderHWnd = CreateWindowEx(WS_EX_CLIENTEDGE, TEXT("DXRender"), NULL,
	   WS_CHILD | WS_VISIBLE, 0, 0, winRect.right * 0.66f,
	   winRect.bottom,
	   g_hWnd, NULL, hInst, NULL);

   g_CtrlToolHWnd = CreateWindowEx(WS_EX_CLIENTEDGE, TEXT("CtrlTool"), NULL,
	   WS_CHILD | WS_VISIBLE, winRect.right * 0.66f, 0, winRect.right,
	   winRect.bottom,
	   g_hWnd, NULL, hInst, NULL);

   int BtnWidth = 80; int BtnHeight = 25; RECT DlgRect;
   //int BtnPosX = 250;
   g_HButton[0] = CreateWindow(TEXT("Button"), TEXT("그리드"),
	   WS_CHILD | WS_VISIBLE | BS_PUSHBUTTON,
	   50, 50, BtnWidth, BtnHeight,
	   g_CtrlToolHWnd, (HMENU)IDC_BTN_CIRCLE,
	   hInst, NULL);*/
	// << :
